...
export function Form() {
  ...
  return (
    <form className=" w-full border-b-gray-200 p-2 rounded-3xl shadow-xl overflow-auto " onSubmit={(e) => {
      ...
      <textarea name="TextPrompt" value={prompt} className=" w-full resize-none focus:outline-none placeholder-gray-500 text-black h-20  overflow-auto p-2 dark:text-gray-400"
